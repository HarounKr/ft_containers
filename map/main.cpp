...
int main(void) {
	...
	std::cout << "           --- Operations ---             \n";
	{
        ...
        NAMESPACE::pair<char,int> p1('x', 19);
        NAMESPACE::pair<char,int> p2('t', 54);
        NAMESPACE::pair<char,int> p3('s', 37);
        NAMESPACE::pair<char,int> p4('f', 6);
        NAMESPACE::pair<char,int> p5('e', 198);
        NAMESPACE::pair<char,int> p6('g', 77);
        NAMESPACE::map<char, int>::iterator it;
		...
		std::cout << "lower_bound('f')--> " << m1.lower_bound('f')->first << " : " << m1.lower_bound('f')->second << std::endl;
		std::cout << "upper_bound('f')--> " << m1.upper_bound('f')->first << " : " << m1.lower_bound('f')->second << std::endl;
	}
	return 0;
}
